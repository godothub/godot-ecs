...
| `add_system(name, system) -> bool`                  | Registers a single-threaded `ECSSystem`.                                             |
| `remove_system(name) -> bool`                       | Removes a system.                                                                    |
| `update(delta: float) -> void`                      | Drives updates for all single-threaded systems and emits the `on_update` signal.     |
| **Event Management**                                |                                                                                      |
